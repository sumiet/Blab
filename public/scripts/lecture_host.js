...
socket.on('createdLecture', function (room){
  console.log('Created room ' + room);
  isInitiator = true;
  navigator.getUserMedia(constraints, handleUserMedia, handleUserMediaError);
  peerList.innerHTML = peerList.innerHTML + "<div id='peerListEntry'> Host: " + nick + "</div>";
...
socket.on('peerJoinedLecture', function (room, peernick) {
...
function handleIceCandidate(event) {
  ...
  if (event.candidate) {
    sendMessage({
      ...
      candidate: event.candidate.candidate},nick,messageSender, room);
  } else {
...
function setLocalAndSendMessage(sessionDescription) {
  ...
  sendMessage(sessionDescription,nick,messageSender,room);
}
